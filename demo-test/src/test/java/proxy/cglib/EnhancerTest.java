...
//
//public class EnhancerTest extends AbstractClassGenerator {
//    private static final CallbackFilter ALL_ZERO = new CallbackFilter() {
//        public int accept(Method method) {
//            return 0;
//        }
//    };
//    private static final Source SOURCE = new Source(EnhancerTest.class.getName());
//    private static final EnhancerTest.EnhancerKey KEY_FACTORY;
...
//    private EnhancerTest.EnhancerFactoryData currentData;
...
//        EnhancerTest.EnhancerFactoryData data = (EnhancerTest.EnhancerFactoryData)instance;
//        if (this.classOnly) {
...
//        }
//
//        EnhancerTest.EnhancerFactoryData factoryData = new EnhancerTest.EnhancerFactoryData(klass, argumentTypes, this.classOnly);
...
//        if (this.currentKey instanceof EnhancerTest.EnhancerKey) {
//            EnhancerTest.EnhancerFactoryData data = (EnhancerTest.EnhancerFactoryData)((WeakReference)cached).get();
//            return data;
//        } else {
...
//        EnhancerTest e = new EnhancerTest();
...
//                e.getfield(EnhancerTest.getCallbackField(key));
//                e.goTo(end);
//            }
//
...
//                e.load_this();
//                e.load_arg(1);
//                e.checkcast(EnhancerTest.this.callbackTypes[key]);
//                e.putfield(EnhancerTest.getCallbackField(key));
//                e.goTo(end);
//            }
//
//            public void processDefault() {
...
//
//            public void processDefault() {
//                e.throw_exception(EnhancerTest.ILLEGAL_ARGUMENT_EXCEPTION, "Constructor not found");
//            }
//        });
//        e.aconst_null();
//        e.invoke_static(thisType, SET_THREAD_CALLBACKS);
...
//                return EnhancerTest.this.getClassLoader();
//            }
//
...
//                EnhancerTest.this.emitCurrentCallback(e, index);
//            }
//
//            public Signature getImplSignature(MethodInfo method) {
//                return EnhancerTest.this.rename(method.getSignature(), (Integer)positions.get(method));
//            }
//
...
//                if (!EnhancerTest.this.interceptDuringConstruction && !TypeUtils.isAbstract(method.getModifiers())) {
...
//
//    static {
//        KEY_FACTORY = (EnhancerTest.EnhancerKey)KeyFactory.create(EnhancerTest.EnhancerKey.class, KeyFactory.HASH_ASM_TYPE, (List)null);
...
//
//            try {
//                this.setThreadCallbacks = EnhancerTest.getCallbacksSetter(generatedClass, "CGLIB$SET_THREAD_CALLBACKS");
//                if (classOnly) {
